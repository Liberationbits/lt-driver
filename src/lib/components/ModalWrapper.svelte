...
<div class="
    ...
    z-20
    w-screen
" transition:fade on:click={closeModal} role="none">
    <div class="
        card
        rounded-3xl
        max-w-4xl
        ...
        overflow-y-auto
        {$$props.class}
    " style="pointer-events: auto; max-height: 80vh;" on:click|stopPropagation={()=>{}} role="none">
            ...
            <div class="relative flex w-full justify-center items-center">
                ...
                {#if title}
                    <div class="flex flex-col items-center py-6">
                        <div class="card-title text-base-100-content text-sm font-medium">
                            {title}
                        </div>
